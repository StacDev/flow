...
- `StacFlowChatView.composerLayout` switches the screen to flow_ui's compact composer.
- `FlowStrings.send` and `FlowStrings.stop` name the composer's send and stop buttons.
